...
他にも Linux / BSD 向けには [Sixel をサポートしたツールが多数あります](https://github.com/saitoha/libsixel?tab=readme-ov-file#related-projects)が、Windows 向けには多くはありません。そもそも Windows はローカル利用・リモートアクセス問わず GUI が基本ですし、当然といえば当然ですね。しかし、そこをあえてやってみるのがロマンというものです。
